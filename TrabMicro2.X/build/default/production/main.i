...
case 3: data = 144 + x; break;
case 4: data = 208 + x; break;
default: break;
}
Lcd_Cmd(data);
while(*buffer)
...
# 2 "txtTelas.h"
char txt11[] = " MENU PRINCIPAL ";
char txt21[] = "MODO: ";
char txt31[] = "STATUS: ";
char txt41[] = "<-            ->";

char txt12[] = " MENU -- CONFIG ";
char txt22[] = "NV MIN CXI: ";
char txt32[] = "NV MIN CXS: ";
char txt42[] = "              ->";

char txt13[] = "     NIVEIS     ";
char txt23[] = "NIVEL CXI: ";
char txt33[] = "NIVEL CXS: ";
char txt43[] = "<-              ";

char txt2e[] = "***   ERRO   ***";
char txt3e[] = "  TENSAO BAIXA  ";
...
else if ((tecla == '3')|(dado == '3'))
{
states[0] = 3;
maketela(states[0]);
atualizatela(states);
}
else if ((tecla == '4')|(dado == '4'))
{
minCXI = minCXI + 10;
if (minCXI > 100)
{
...
if (states[1] == 0)
{
if ((tensaoCXI >= 1.4 && tensaoCXS <= 3.0) && (states[2]==0))
{
PORTCbits.RC0 = 0x01;
states[2] = 1;
}
else if ((tensaoCXI <= 1.0 || tensaoCXS <= 4.6) && (states[2]==1))
{
PORTCbits.RC0 = 0x01;
}
else
...
void transmitedados()
{
sprintf(buffer_tx, "/*%04d", adc_amostra(0));
serial_tx_str(buffer_tx);
sprintf(buffer_tx, "/%04d", adc_amostra(1));
serial_tx_str(buffer_tx);
sprintf(buffer_tx, "/%02d", states[1]);
serial_tx_str(buffer_tx);
sprintf(buffer_tx, "%02d", states[2]);
serial_tx_str(buffer_tx);
sprintf(buffer_tx, "/%02d", minCXI);
serial_tx_str(buffer_tx);
